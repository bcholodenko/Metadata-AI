...
if __name__ == "__main__":
    ...
    process_archive(directory, cutoff_year, confidence_threshold, xmp_only, enable_geo, recursive)            formatted_date = f"{raw_date[:4]}:{raw_date[4:6]}:{raw_date[6:8]} 12:00:00"
